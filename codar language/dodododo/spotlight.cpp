...
int main()
{
    ...
    Shader *lightingshdr = new Shader("shaders/lightmaps.vs","shaders/spotlight.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingshdr->setVec3("light.position", camera.Position);
        lightingshdr->setVec3("light.direction", camera.Front);
        lightingshdr->setFloat("light.cutOff", glm::cos(glm::radians(12.5f)));
        lightingshdr->setFloat("light.outerCutOff", glm::cos(glm::radians(17.5f)));

        lightingshdr->setVec3("light.ambient", 0.2f, 0.2f, 0.2f);
        lightingshdr->setVec3("light.diffuse", 0.5f, 0.5f, 0.5f);
        lightingshdr->setVec3("light.specular", 1.0f,1.0f,1.0f);

        lightingshdr->setFloat("light.constant", 1.0f);
        lightingshdr->setFloat("light.linear", 0.09f);
        lightingshdr->setFloat("light.quadratic", 0.032f);

        lightingshdr->setVec3("material.ambient", 1.0f, 0.5f, 0.31f);
        lightingshdr->setVec3("material.diffuse", 1.0f, 0.5f, 0.31f);
        lightingshdr->setVec3("material.specular", 0.5f, 0.5f, 0.5f);
