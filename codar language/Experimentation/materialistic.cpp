...
int main()
{
    ...
    Shader *lightingshdr = new Shader("shaders/basiclighting.vs","shaders/materials.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingshdr->setVec3("light.ambient",ambientColor);
        lightingshdr->setVec3("light.diffuse",diffuseColor);
